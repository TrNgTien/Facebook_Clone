        ...
        <div className='container__background' onClick={closeModal} ref={modalRef}>
          <div className='modal-wrapper'>
            <div className='modal-wrapper__left'>
              <img className='img-content' src={feedAttachments} alt='camera' />
              <MdOutlineClose
            ...
            <div className='modal-wrapper__right'>
              <div className='container__content'>
                <div className='container__info'>
                  <img className='avatar-img' src={poster.userAvatar} alt='avatar' />
                  <div className='content__info'>
                    <p className='content__info__username'>{poster.username}</p>
                    <p className='content__info__timestamp'>{time}</p>
                  </div>
                </div>
                <p className='content__para'>{description}</p>
              </div>
