    ...
    <div className='messaging-area'>
      ...
      <div className='messaging-area__body'>
        {msgs.map((msg, index) => 
          <div className="message-container-line" key={index} ref={scrollRef}>
              <div className={msg.user === true ? "container-msg container-msg--mine-msg" : "container-msg container-msg--yours-msg"}>
      ...
      <div className='messaging-area__footer'>
        ...
        <div className='input-message-and-emoji'>
          <input className='input-message' type='text' placeholder="Aa" onChange={e => setText(e.target.value)}/>
          <div className='emoji'>
            <BsFillEmojiSmileFill/>
          </div>
        </div>
