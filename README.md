...
•	Requirements Analysis:
    ...
    o	Business requirements:
            1. These include high-level statements of goals, objectives, and needs. 
            2. Business requirements do not include any details or specific features. 
            3. They just state the problem and the business objective to be achieved such as:
    ...
    o	Transition requirements:
            1. An additional group of requirements defines what is needed from an organization to successfully move from its current state to its desired state with the new product. 
            2. They are only necessary for the short period of time while the transition takes place. 
            3. Examples can be “users must be trained to operate the system” or “previous data must be migrated to the cloud storage.”
